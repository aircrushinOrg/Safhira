        ...
        <div className="container mx-auto max-w-4xl">
          <Card className="p-8 text-center bg-gradient-to-br from-primary/5 to-secondary/5">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">You have successfully completed the quiz</p>
            </div>

            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-card rounded-lg p-6">
                <div className="text-3xl font-bold text-primary mb-2">{score}/{quizQuestions.length}</div>
                <div className="text-muted-foreground">Correct Answers</div>
              </div>
              <div className="bg-card rounded-lg p-6">
                <div className="text-3xl font-bold text-primary mb-2">{scorePercentage.toFixed(0)}%</div>
            ...
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-4">Message from Jun Kang:</h3>
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="mb-8">
          ...
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-3xl font-bold text-foreground">Reproductive Health Quiz</h1>
        ...
        <Card className="p-6 bg-gradient-to-r from-primary/5 to-secondary/5">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <span className="font-semibold text-foreground">Jun Kang&apos;s Tip</span>
          </div>
          <p className="text-muted-foreground text-sm">
