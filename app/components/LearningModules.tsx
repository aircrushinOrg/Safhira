      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {modules.map((module, index) => (
            <Card key={module.id} className="p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:shadow-lg transition-shadow cursor-pointer"
                  onClick={() => onModuleClick(module.id)}>
              <div className="flex items-start justify-between mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center bg-${module.color}-100 dark:bg-${module.color}-900`}>
              ...
              <div className="space-y-1 mb-4">
                {module.topics.slice(0, 2).map((topic, topicIndex) => (
                  <div key={topicIndex} className="text-xs text-gray-600 dark:text-gray-400 flex items-center space-x-2">
