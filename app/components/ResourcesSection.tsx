...
export function ResourcesSection() {
  ...
  return (
    <section className="py-16 px-4 bg-gradient-to-br from-background to-background">
      <div className="container mx-auto max-w-6xl">
        ...
        <Card className="p-6 mb-12 bg-gradient-to-r from-destructive/5 to-destructive/10 border-destructive/20">
            ...
            {emergencyInfo.items.map((item, index) => (
              <div key={index} className="bg-card rounded-lg p-4">
                <div className="flex items-start space-x-3 mb-3">
                  <item.icon className="text-destructive flex-shrink-0 mt-1" size={20} />
          ...
          {resources.map((resource, index) => (
            <Card key={index} className="p-6 bg-card/80 backdrop-blur-sm">
              <div className="flex items-start justify-between mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center bg-${resource.color}/10`}>
        ...
        <Card className="p-6 bg-gradient-to-r from-primary/5 to-secondary/5">
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div>
                <h4 className="font-semibold text-foreground mb-2">Government Health Clinics</h4>
                <p className="text-muted-foreground">Monday - Friday: 8:00 AM - 5:00 PM</p>
                <p className="text-muted-foreground">Saturday: 8:00 AM - 1:00 PM</p>
              </div>
              <div>
                <h4 className="font-semibold text-foreground mb-2">Government Hospitals</h4>
                <p className="text-muted-foreground">24 Hours (Emergency)</p>
                <p className="text-muted-foreground">Clinics: 8:00 AM - 5:00 PM</p>
              </div>
              <div>
                <h4 className="font-semibold text-foreground mb-2">Private Clinics</h4>
                <p className="text-muted-foreground">According to clinic schedule</p>
                <p className="text-muted-foreground">Usually 9:00 AM - 9:00 PM</p>
              </div>
            </div>
          </div>
        </Card>
        ...
        <div className="text-center mt-8">
          <Card className="p-4 bg-primary/10 border-primary/20 inline-block">
